...
<body>
    ...
    <form method="POST" action="index.php?action=edit&id=<?php echo $tripulante_data->numTripulante;?>">
        ...
        <label>Submarino: <input type="text" name="submarino" value="<?php echo htmlspecialchars($tripulante_data->submarino); ?>" required></label><br>
        <label>Viaja: <input type="checkbox" name="viaja" <?php echo $tripulante_data->viaja ? 'checked' : ''; ?>></label><br>
        <button type="submit" name="update">Actualizar Tripulante</button>
    </form>
